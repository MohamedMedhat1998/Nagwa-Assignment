...
class CancelDownload @Inject constructor(
    ...
    UseCase<CancelDownload.CancelDownloadRequestValues, UseCase.NoResponseValues, UseCase.NoProgressValues>() {
    ...
    override suspend fun executeUseCase(requestValues: CancelDownloadRequestValues?) {
        ...
        workManager.cancelAllWorkByTag(requestValues.dataItem.id.toString())
        // TODO update the UI.
